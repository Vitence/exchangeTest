...
//活的k线数据
function getKData(typeN){
  var resultData = new Array();
  $.ajax({
    url:'/transaction/getkdata',
    data:{type:typeN},
    type:'get',
    async:false,
    success:function(result){
      ...
      for(var i = 0 ; i < result.data.length ; i++){
        resultData[i] = [result.data[i].date,Number(result.data[i].open_price),Number(result.data[i].close_price),Number(result.data[i].min),Number(result.data[i].max),Number(result.data[i].deal_number), 0, 0.11, -0.28, -0.34];
      }
...
var cbfdata=splitData([['2018-01-22', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-23', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-24', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-25', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-26', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-29', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-30', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-01-31', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-01', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-02', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-05', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-06', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-07', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-08', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-09', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-10', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-11', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-12', 0.20, 0.20, 0.20, 0.20, 0.00, 0, 0.11, -0.28, -0.34]
                      ]);
...
var qrtbdata=splitData([['2018-02-01', 42, 42, 42, 42, 0.00, 0, 0.11, -0.28, -0.34],
                        ['2018-02-02',  42, 42, 42, 42, 0.00,0, 0.14, -0.28, -0.35],
                        ['2018-02-05', 42, 42, 42, 42, 0.00, 0, 0.12, -0.31, -0.37],
                        ['2018-02-06',  42, 42, 42, 42, 0.00, 0, 0.07, -0.35, -0.39],
                        ['2018-02-07',  42, 42, 42, 42, 0.00, 0, 0.03, -0.38, -0.40],
                        ['2018-02-08',  42, 42, 42, 42, 0.00, 1, 0.01, -0.40, -0.40],
                        ['2018-02-09',  42, 42, 42, 42, 0.00, 0, -0.09, -0.45, -0.40],
                        ['2018-02-10',  42, 42, 42, 42, 0.00, 1, 0.01, -0.40, -0.40],
                        ['2018-02-11',  42, 42, 42, 42, 0.00, 0, -0.09, -0.45, -0.40],
                        ['2018-02-12',  42, 42, 42, 42, 0.00, 0, -0.09, -0.45, -0.40]
                        ]);

var twdhqInitData = [['2018-02-05', 16.38, 17.9, 16.38, 18.1, 183000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-06', 17.9, 18.2, 17.15, 18.3, 217000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-07', 18.11, 18.88, 18.11, 19.11, 204000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-08', 18.5, 20.1, 18.33, 20.5, 193000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-09', 20.8, 19.6, 18.91, 21.24, 257000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-10', 19.6, 19.03, 18.88, 19.8, 175000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-11', 19.34, 21.65, 19.34, 22.2, 248000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-12',  20.9, 20, 19.6, 21.4, 121000, 0, -0.09, -0.45, -0.40]
                          ];

var myjfInitData = [['2018-01-31', 10, 9, 9, 10, 178000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-01', 9, 8.1, 8.1, 9, 183000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-02', 8, 7.2, 7.2, 8, 175000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-05', 7.1, 6.49, 6.49, 7.1, 177000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-06', 6.5, 7.35, 6.5, 7.35, 210000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-07', 7.5, 8.25, 7.5, 8.25, 204000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-08', 8.5, 7.75, 7.75, 8.5, 198000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-09', 7.5, 8.25, 7.5, 8.25, 201000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-10', 8.4, 9.24, 8.4, 9.24, 234000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-11', 9.3, 10.23, 9.3, 10.23, 245000, 0, 0.11, -0.28, -0.34],
                          ['2018-02-12',  10.4, 11.44, 10.4, 11.44, 349000, 0, -0.09, -0.45, -0.40]
                          ];
